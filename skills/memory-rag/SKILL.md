  ...
  tools:
    definitions:
      - name: store_memory
        ...
        command: python3 scripts/store_memory.py
        timeout-s: 30
        parameters:
          type: object
          properties:
      ...
      - name: recall_memory
        ...
        command: python3 scripts/recall_memory.py
        timeout-s: 30
        parameters:
          type: object
          properties:
      ...
      - name: list_memories
        ...
        command: python3 scripts/list_memories.py
        timeout-s: 30
        parameters:
          type: object
          properties:
      ...
      - name: forget_memory
        ...
        command: python3 scripts/forget_memory.py
        timeout-s: 30
        parameters:
          type: object
          properties:
      ...
      - name: get_memory_stats
        ...
        command: python3 scripts/get_memory_stats.py
        timeout-s: 30
        parameters:
          type: object
          properties: {}
      ...
      - name: export_memories
        ...
        command: python3 scripts/export_memories.py
        timeout-s: 30
        parameters:
          type: object
          properties:
