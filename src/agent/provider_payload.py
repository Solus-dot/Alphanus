...
def payload_to_mode(
    ...
    *,
    ...
    if tools is not None:
        converted_tools = chat_tools_to_responses(tools) if mode == ENDPOINT_MODE_RESPONSES else responses_tools_to_chat(tools)
...
def build_payload(
    *,
    ...
    if selected_mode == ENDPOINT_MODE_RESPONSES:
        ...
        if tools:
            payload["tools"] = cast(JSONValue, chat_tools_to_responses(tools))
