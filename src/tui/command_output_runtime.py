...
def cmd_memory(app: Any, arg: str) -> bool:
    ...
    if sub == "stats":
        ...
        app._write_detail_line("allow_model_download", str(stats.get("allow_model_download", False)).lower())
        app._write_detail_line("encoder_status", str(stats.get("encoder_status", "")))
        app._write_detail_line("encoder_source", str(stats.get("encoder_source", "")))
        if stats.get("encoder_detail"):
            app._write_detail_line("encoder_detail", str(stats.get("encoder_detail", "")))
        app._write_detail_line("model", str(stats["model_name"]))
        app._write_detail_line("recommended_model", str(stats.get("recommended_model_name", "")))
        app._write_detail_line("dimension", str(stats["dimension"]))
...
def cmd_doctor(app: Any, *, accent_color: str) -> None:
    ...
    app._write_detail_line("memory_allow_model_download", str(memory.get("allow_model_download", False)).lower())
    app._write_detail_line("memory_encoder_status", str(memory.get("encoder_status", "")))
    app._write_detail_line("memory_encoder_source", str(memory.get("encoder_source", "")))
    if memory.get("encoder_detail"):
        app._write_detail_line("memory_encoder_detail", str(memory.get("encoder_detail", "")))
    app._write_detail_line("memory_model", str(memory.get("model_name", "")))
    app._write_detail_line("recommended_model", str(memory.get("recommended_model_name", "")))
